  ...
  return (
    <>
      <div className="highlight-container">
        ...
        <Card className="h-card">
          <div className="h-title">Rüzgar Hızı</div>
          <img
        ...
        <Card className="h-card">
          <div className="h-title">Bulutlar</div>
        ...
        <Card className="h-card">
          <div className="h-title">UV Endeksi</div>
          <img src="/weather_icons/uv.png" width={100} alt="" />
          <h1>{current.uvi}</h1>
        </Card>
        <Card className="h-card">
          <div className="h-title">Basınç</div>
